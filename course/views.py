...
def course_list_creator(request, username):
	try:
		user = User.objects.get(username=username)
	except User.DoesNotExist:
		raise Http404('user does not exist')
	...
	return render(request, 'course/course_list_creator.html', context=context)


def course_list_instructor(request, username):
	try:
		user = User.objects.get(username=username)
	except User.DoesNotExist:
		raise Http404('user does not exist')
	...
	return render(request, 'course/course_list_instructor.html', context=context)


def course_list_student(request, username):
	...
	return render(request, 'course/course_list_student.html', context=context)
