...
TEMPLATE_DIR_MAIN = os.path.join(MAIN_DIR, 'templates')


REGISTRATION_DIR = os.path.join(BASE_DIR, 'registration')
TEMPLATE_DIR_REGISTRATION = os.path.join(REGISTRATION_DIR, 'templates')
...
SECRET_KEY = '!ngool%ob(#1mk$rr#l7@)8nxa40kyac@kgtxgve60bo+rr^-l'
...
TEMPLATES = [
    {
        ...
        'DIRS': [TEMPLATE_DIR, TEMPLATE_DIR_MAIN, TEMPLATE_DIR_REGISTRATION, ],
        'APP_DIRS': True,
        'OPTIONS': {
            'context_processors': [
